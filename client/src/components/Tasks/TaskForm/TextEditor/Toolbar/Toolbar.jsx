...
import { CAN_REDO_COMMAND, CAN_UNDO_COMMAND, SELECTION_CHANGE_COMMAND, $getSelection, $isRangeSelection } from "lexical";
    ...
    return (
        ...
        <div className="toolbar flex" ref={toolbarRef}>
            ...
            <BlockOptions
                ...
                blockType={blockType}
            />
            <TextFormatting editor={editor} isBold={isBold} isItalic={isItalic} isUnderline={isUnderline} isStrikethrough={isStrikethrough} />
