...
const generateAndSendAuthTokens_1 = __importDefault(
  require("../utils/auth/generateAndSendAuthTokens"),
);
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (password.length < 8)
        return res
          .status(400)
          .json(responseMessages_1.minimumPasswordLengthError);
...
router.post("/login", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // Verify password
      const hashedPassword = crypto_js_1.default.AES.decrypt(
        user.password,
        PASSWORD_SECRET,
      );
      const userPassword = hashedPassword.toString(
...
router.post("/forgot-password", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const token = (0, createToken_1.createResetPasswordToken)({
        email: user.email,
      });
