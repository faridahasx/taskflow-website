...
// ADD
router.post("/", authVerify_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (categoriesCount >= 25)
        return res
          .status(400)
          .json(responseMessages_1.maximumCategoriesReached);
      // Create category
...
// EDIT TITLE
router.patch("/:title", authVerify_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      let user = req.user;
      // Validate input
      ...
      const updateCategory = category_1.default.findOneAndUpdate(
        { title: req.params.title, userId: user.userId },
        { title: newTitle },
      );
      const updateTasks = task_1.default.updateMany(
...
// DELETE
router.delete("/:title", authVerify_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      let user = req.user;
