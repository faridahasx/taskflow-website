...
router.post(
  "/",
  authVerify_1.default,
  validateTaskInputs_1.validateTaskInputs,
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        let user = req.user;
        const newTask = new task_1.default(
          Object.assign(Object.assign({}, req.body), { userId: user.userId }),
        );
        yield newTask.save();
...
router.get("/", authVerify_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      let user = req.user;
      ...
      const { id } = req.query;
      if (id) {
        let data = yield task_1.default.findOne({
          _id: id,
          userId: user.userId,
        });
        res.status(200).json([data]);
      } else {
        let query = new taskQuery_1.default(
          task_1.default.find({}, "-description -userId"),
          reqQuery,
          user.userId,
        )
          .filtering()
...
router.get("/:id", authVerify_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      let user = req.user;
      const taskDescription = yield task_1.default.findOne(
...
router.patch(
  ...
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        let user = req.user;
        const task = yield task_1.default.findOneAndUpdate(
          { _id: req.params.id, userId: user.userId },
          {
            $set: req.body,
          },
        ...
        if (!task) return res.status(404).json(responseMessages_1.taskNotFound);
...
// EDIT TASK COMPLETED
router.patch("/completed/:id", authVerify_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
// DELETE TASKS
router.delete("/:id", authVerify_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      let user = req.user;
