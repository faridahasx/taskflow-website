...
const oauth2Client = new OAuth2(MAILING_SERVICE_CLIENT_ID, MAILING_SERVICE_CLIENT_SECRET, MAILING_SERVICE_REFRESH_TOKEN);
// send mail
const sendEmail = (to, url) => __awaiter(void 0, void 0, void 0, function* () {
