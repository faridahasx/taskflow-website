...
exports.createResetPasswordToken = exports.createAccessToken = exports.createRefreshToken = void 0;
...
const createResetPasswordToken = (payload) => {
    return jsonwebtoken_1.default.sign(payload, JWT_RESET_PASSWORD_REFRESH_TOKEN_SECRET, {
        expiresIn: "15m",
    });
};
